    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="card p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                @else
                    <div class="inline-flex items-center justify-center gap-2 bg-gray-100 text-gray-400 text-sm font-medium py-2.5 px-5 rounded-xl cursor-not-allowed select-none">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"/></svg>
                        Link pembelajaran belum tersedia
                    </div>
                @endif
                <a href="{{ route('dashboard') }}" class="btn-outline inline-flex items-center justify-center">
                    Dashboard Saya
                </a>
            </div>
        </div>
