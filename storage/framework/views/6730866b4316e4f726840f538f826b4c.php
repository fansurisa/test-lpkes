...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="input" value="<?php echo e(old('name')); ?>"
    ...
    <p class="text-center text-sm text-gray-500 mt-5">
        Sudah punya akun?
        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-primary-600 hover:text-primary-700">Masuk</a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/fansuriarrumi/Documents/lpkesolutions/resources/views/auth/register.blade.php ENDPATH**/ ?>