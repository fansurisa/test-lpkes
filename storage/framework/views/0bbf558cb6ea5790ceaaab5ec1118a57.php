...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" class="input" value="<?php echo e(old('email')); ?>"
        ...
        <div class="flex items-center justify-between text-sm">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-primary-600 hover:text-primary-700 font-medium">
                    Lupa kata sandi?
                </a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <p class="text-center text-sm text-gray-500 mt-5">
        Belum punya akun?
        <a href="<?php echo e(route('register')); ?>" class="font-semibold text-primary-600 hover:text-primary-700">Daftar sekarang</a>
    </p>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/fansuriarrumi/Documents/lpkesolutions/resources/views/auth/login.blade.php ENDPATH**/ ?>