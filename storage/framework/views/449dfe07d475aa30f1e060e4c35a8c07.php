...
<?php $__env->startSection('content'); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="<?php echo e(route('catalog.index')); ?>" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-primary-600 font-semibold hover:bg-gray-50 transition-colors shadow-md">
                        Jelajahi Pelatihan
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
                    </a>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-white/50 text-white font-semibold hover:bg-white/10 transition-colors">
                            Daftar Gratis
                        </a>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('catalog.index')); ?>" class="btn-outline text-sm hidden sm:inline-flex">
                Lihat Semua
            </a>
        </div>
        ...
        <div class="mt-6 text-center sm:hidden">
            <a href="<?php echo e(route('catalog.index')); ?>" class="btn-outline">Lihat Semua Pelatihan</a>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                    ...
                    <div class="bg-white rounded-xl p-6 shadow-sm">
                        ...
                        <h3 class="font-bold text-gray-900 mb-2"><?php echo e($feature['title']); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/fansuriarrumi/Documents/lpkesolutions/resources/views/home.blade.php ENDPATH**/ ?>